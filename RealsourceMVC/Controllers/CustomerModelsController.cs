...
namespace RealsourceMVC.Controllers
{
    public class CustomerModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Name,email")] CustomerModel customerModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Name,email")] CustomerModel customerModel)
        {
            if (ModelState.IsValid)
            {
